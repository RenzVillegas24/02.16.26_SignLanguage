 ...
 *
 * Sensor reading runs on a background FreeRTOS task (Core 0) to avoid
 * blocking the LVGL rendering loop on Core 1.  An I2C mutex coordinates
 * bus access between the sensor task and the FT3168 touch controller.
 */
#pragma once
